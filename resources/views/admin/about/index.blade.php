...
@section('tbody')
    @foreach($items as $item)
        <tr>
            ...
            <td>
                @includeIf("admin.components.buttons.edit" , ["href" => "about/$item->id/edit"])
                @includeIf("admin.components.buttons.delete",["message" => "($item->name)" ,"action" => url("admin/about/$item->id")])
